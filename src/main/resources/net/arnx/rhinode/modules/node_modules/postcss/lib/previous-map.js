...
var PreviousMap = function () {
    ...
    PreviousMap.prototype.decodeInline = function decodeInline(text) {
        ...
        if (this.startWith(text, uri)) {
            ...
            return new JString(Base64.getDecoder().decode(text.substr(b64.length)), 'UTF-8');
        } else if (this.startWith(text, utf64)) {
            return new JString(Base64.getDecoder().decode(text.substr(utf64.length)), 'UTF-8');
        } else if (this.startWith(text, utfd64)) {
            return new JString(Base64.getDecoder().decode(text.substr(utfd64.length)), 'UTF-8');
        } else {
